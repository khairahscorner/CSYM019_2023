...
if ($_SESSION["authenticated"] !== true) {
    ...
    if (isset($_POST['submit'])) { // Muawya code
        ...
        if ($result) {
            ...
            $stmt = $pdo->prepare('INSERT INTO courses (level, duration_fulltime, duration_placement, start_dates, location,
    icon_url, course_name, subject, link_url, summary, highlights, english_req, fees_year, fees_uk_fulltime, fees_intl_fulltime,
    faqs, related_courses, created_at)
    VALUES (:level, :dft, :dp, :dates, :location, :icon, :cname, :subject, :link, :summary, :highlights, :english_req, :fyear, 
    :ukft, :intlft, :faqs, :rel, :created)');
